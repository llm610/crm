            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label for="create-permissionName" class="col-sm-2 control-label">名称<span
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="create-operationUrl" style="width: 200%;"
                                   placeholder="多个用逗号隔开">
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label for="edit-permissionName" class="col-sm-2 control-label">名称<span
                                style="font-size: 15px; color: red;">*</span></label>
                        <div class="col-sm-10" style="width: 300px;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="edit-operationUrl" style="width: 200%;"
...
<div style="position: absolute; width: 80%; height: 100%; overflow: auto; left: 20%;">
    ...
    <div style="position: relative; left: 30px; top: -10px;">
        ...
        <div style="position: relative; height: 50px; width: 250px;  top: -72px; left: 60%;">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#createPermissionModal"><span
                    class="glyphicon glyphicon-plus"></span> 新增
            </button>
            <button type="button" class="btn btn-default" data-toggle="modal" data-target="#editPermissionModal"><span
    ...
    <div style="position: relative; top: -70px;">
        ...
        <div style="position: relative; left: 40px; height: 30px; top: 60px;">
            ...
            <div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>activity/create.do,activity/edit.do,activity/delete.do</b>
            </div>
            <div style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
        </div>
