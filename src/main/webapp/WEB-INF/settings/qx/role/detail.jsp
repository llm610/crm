            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label for="edit-roleCode" class="col-sm-2 control-label">代码<span
                    ...
                    <div class="form-group">
                        <label for="edit-roleName" class="col-sm-2 control-label">名称<span
                                style="font-size: 15px; color: red;">*</span></label>
                        <div class="col-sm-10" style="width: 300px;">
        ...
        <div class="tab-pane fade in active" id="role-info">
            <div style="position: relative; top: 20px; left: -30px;">
                ...
                <div style="position: relative; left: 40px; height: 30px; top: 60px;">
                    ...
                    <div style="width: 200px;position: relative; left: 200px; top: -20px;">
                        <b>理员拥有最高权限管理员拥有最高权限管理员拥有最高权限</b></div>
                    <div style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
                    <button style="position: relative; left: 76%;" type="button" class="btn btn-default"
                            data-toggle="modal" data-target="#editRoleModal"><span
            ...
            <div style="position: relative; top: 20px; left: 0px;">
                ...
                <div style="position: relative;top: 30px; left: 76%;">
                    <button type="button" class="btn btn-default" data-toggle="modal"
                            data-target="#assignPermissionForRoleModal"><span class="glyphicon glyphicon-edit"></span>
                        分配许可
                    </button>
                </div>
            </div>
