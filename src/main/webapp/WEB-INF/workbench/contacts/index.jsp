...
<head>
    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            $("input.time:first").datetimepicker({
                minView: "month",
                language:  'zh-CN',
            ...
            $("#createBtn").click(function () {
                // 所有者默认是当前登录的用户
                $("#create-contactsOwner").val("${user.loginAct} | ${user.name}");
                ...
                <form id="createForm" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <select name="owner" class="form-control" id="create-contactsOwner"></select>
                        </div>
                    ...
                    <div class="form-group" style="position: relative;">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <input name="birth" type="text" class="form-control time" id="create-birth">
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="position: relative;">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <input name="customerId" type="text" class="form-control" id="create-customerName"
                    ...
                    <div style="position: relative;top: 15px;">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" style="width: 81%;">
                                <textarea name="contactSummary" class="form-control" rows="3" id="create-contactSummary1"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="create-nextContactTime1" class="col-sm-2 control-label">下次联系时间</label>
                            <div class="col-sm-10" style="width: 300px;">
                                <input name="nextContactTime" type="text" class="form-control time" id="create-nextContactTime1">
                            </div>
                        </div>
                    </div>
    ...
    <div style="width: 100%; position: absolute;top: 5px; left: 10px;">
        ...
        <div class="btn-toolbar" role="toolbar"
            ...
            <div class="btn-group" style="position: relative; top: 18%;">
                <button id="createBtn" type="button" class="btn btn-primary" data-toggle="modal" data-target="#createContactsModal">
